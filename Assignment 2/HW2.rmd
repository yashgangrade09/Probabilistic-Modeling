...
Total number of probabilities needed in order to get the full joint distribution = $\prod_{i=1}^{10} (\text{number of probability cases per graph node}) $ = $2^{15} = 32768$
