...
stroke_bmi_bp_cholesterol_exercise_smoke = createCPTfromData(x = file[, c(8,4,5,6,2,3)], varnames = c("stroke", "bmi", "bp", "cholesterol", "exercise", "smoke"));
...
bayesnet = list("1" = income, "2" = smoke_income, "3" = bmi_income_excercise, "4" = exercise_income, "5" = bp_income_exercise_smoke, 
                "6" = cholesterol_income_exercise_smoke, "7" = diabetes_bmi_exercise_smoke, "8" = stroke_bmi_bp_cholesterol_exercise_smoke, 
