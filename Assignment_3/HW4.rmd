...
## Question 1.3
resultant_img = get_estimated_variance_prior_posterior(img1, 0.5, 1.5, 2.5, 100, 25) 
...
# 10000 samples of beta with epsilo = 0.2, L = 20, burn-in = 200
sample_beta = HMC_util(0.5, 20, 10000, 100)
#print(sample_beta)
