...
resultant_img = gibbs_sampling_prior(binary_img, -0.1, 0.5, 2.5, 100, 5);
display_image(resultant_img)
#
cat("Negative Alpha and Low Beta \n")
resultant_img = gibbs_sampling_prior(binary_img, -0.1, 0.1, 2.5, 100, 5);
display_image(resultant_img)
#
...
# #
# cat("We used alpha = 0, beta = 2.2, sigma = 1.4 with 100 iterations and 20 burn-in samples. The clean image is shown below \n")
# resultant_img = gibbs_sampling_prior_posterior(img2, 0, 5, 2.5, 100, 20);
# display_image(resultant_img)
# 
# ## Question 1.3
...
# display_image(resultant_img)
# 
# resultant_img = gen_estimated_variance(img2, 0.2, 5, 2.5, 100, 20)
# display_image(resultant_img)
...
cat("For the predicted labels, the accuracy of classification is \n")
