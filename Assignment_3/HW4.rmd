...
resultant_img = gibbs_sampling_prior(binary_img, -0.5, 0.5, 2.5, 100, 5);
display_image(resultant_img)
#
cat("Negative Alpha and Low Beta \n")
resultant_img = gibbs_sampling_prior(binary_img, -0.5, 0.1, 2.5, 100, 5);
display_image(resultant_img)
#
cat("Positive Alpha and Positive High Beta \n")
resultant_img = gibbs_sampling_prior(binary_img, 0.3, 0.5, 2.5, 100, 5);
display_image(resultant_img)
#
cat("Positive Alpha and Low Beta \n")
resultant_img = gibbs_sampling_prior(binary_img, 0.3, 0.1, 2.5, 100, 5);
display_image(resultant_img)
#
# ## Question 1.2
