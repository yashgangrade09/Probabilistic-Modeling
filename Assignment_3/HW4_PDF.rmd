...
### Solution: 
Here, we just use the ising prior to get the images. We are also generating binary random images using the indigenous rand_generator function written. Here, we are testing with different values of alpha, beta, and sigma. Different category of images are shown in the results.
...
resultant_img = gibbs_sampling_prior(binary_img, -0.1, 4, 1.5, 50, 5);
display_image(resultant_img)
# #
# cat("Negative Alpha and Low Beta \n")
resultant_img = gibbs_sampling_prior(binary_img, -0.1, 0.5, 1.5, 50, 5);
display_image(resultant_img)
# #
