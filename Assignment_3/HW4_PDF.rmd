...
cat("For the predicted labels, the accuracy of classification is calculated below. \n")
testing_classification_accuracy(prediction)

cat("The posterior predictive probability for each testing data point is shown in form of array below. \n")
...
cat("For the average classification, the accuracy of classification is calculated below. \n")
